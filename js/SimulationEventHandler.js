        ...
        this.simulation.canvas.addEventListener('click', (e) => {
            ...
            if (clickedNode) {
                ...
                if (this.simulation.playerCanDropNodes) {
                    const node = this.simulation.addNode(Math.floor(coords.x), Math.floor(coords.y));
                    if (node) {
                        // after the first successful player-initiated drop, disable further manual drops
